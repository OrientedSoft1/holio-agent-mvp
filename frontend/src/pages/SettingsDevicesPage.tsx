    ...
    <div className="flex h-screen flex-col bg-holio-offwhite">
      ...
      <div className="flex-1 overflow-y-auto pb-8">
        ...
        <div className="mx-4 rounded-2xl bg-white dark:bg-gray-900 p-5">
          <div className="mx-auto mb-4 flex h-40 w-40 items-center justify-center rounded-2xl border-2 border-dashed border-gray-200 dark:border-gray-600">
        ...
        {sessions.length > 0 && (
          <>
                ...
                return (
                  <div key={ses.id}>
                    ...
                    <div className="flex items-center gap-3 px-4 py-3">
                      ...
                      <button onClick={() => terminateSession(ses.id)} className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full hover:bg-red-50 dark:hover:bg-red-950">
            ...
            <div className="mx-4 mt-4">
              <button onClick={() => setShowConfirm(true)} className="flex w-full items-center justify-center gap-2 rounded-2xl bg-red-50 dark:bg-red-950 py-3.5 text-sm font-semibold text-red-600 hover:bg-red-100">
